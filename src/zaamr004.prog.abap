REPORT ZAAMR004 NO STANDARD PAGE HEADING LINE-SIZE 255 LINE-COUNT 65.
************************************************************************
* Program     : ZAAMR004
...
* Date        : May 1997.
*
* Description : Displays the ASSET MANAGEMENT/BUSINESS SECTOR QUERY
...
SELECT-OPTIONS:
      S_ORD42     FOR ANLA-ORD42.       "Business Sector
...
WRITE: /.
ULINE.
WRITE: / TEXT-034, TEXT-035.                                  "md7140
ULINE.
...
SELECT * FROM ANLA                     "All other details for report
    WHERE ORD42 IN S_ORD42
    AND BUKRS = P_BUKRS.

    PERFORM CREATE_TABLE.
ENDSELECT.

SORT: TABLE1 BY ORD42 ANLN1 ANLN2.
