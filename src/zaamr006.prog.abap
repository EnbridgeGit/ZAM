REPORT ZAAMR006 NO STANDARD PAGE HEADING LINE-SIZE 255 LINE-COUNT 65.
************************************************************************
* Program     : ZAAMR006
...
* Date        : May 1997.
*
* Description : Displays the ASSET MANAGEMENT/RECTIFIER NUMBER QUERY
...
SELECT-OPTIONS:
      S_SERNR    FOR ANLA-SERNR.      "Rectifier Number
