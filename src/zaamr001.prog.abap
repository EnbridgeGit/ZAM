REPORT ZAAMR001 NO STANDARD PAGE HEADING LINE-SIZE 255 LINE-COUNT 65.
************************************************************************
* Program     : ZAAMR001
...
* Date        : May 1997.
*
* Description : Displays the ASSET MANAGEMENT/ASSET NUMBER QUERY
*               based on the selection criteria.
************************************************************************
* 97/09/21 md7140 calculate current aquisition value
*                 - add end of page notation
************************************************************************
...
SELECT * FROM ANLA                     "All other details for report
    WHERE GDLGRP IN S_GDLGRP
    AND BUKRS = P_BUKRS.

    PERFORM CREATE_TABLE.
ENDSELECT.

SORT: TABLE1 BY GDLGRP ANLN1 ANLN2.
...
*            table1-kansw  under text-024,          "Acquisition Value
    ...
    IF  TABLE1-CURBAL = TABLE1-KANSW.                         "97/09/22
...
FORM CREATE_TABLE.
   ...
   SELECT * FROM ANLC
      ...
      TABLE1-CURBAL = ANLC-KANSW + ANLC-ANSWL + ANLC-KINVZ + ANLC-INVZM.
    ENDSELECT.
